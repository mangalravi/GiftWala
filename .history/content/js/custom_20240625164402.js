...
const registerBtn = document.getElementById("register");
const loginBtn = document.getElementById("login");
const leftHeading = document.querySelector(".lefttxt");
const rightHeading = document.querySelector(".rgttxt");
...
// Function to toggle CSS properties for buttons and headings
function toggleElements() {
  // Toggle buttons
  if (registerBtn.style.opacity === "0") {
    registerBtn.style.opacity = "1";
    registerBtn.style.zIndex = "999";
    loginBtn.style.opacity = "0";
    loginBtn.style.zIndex = "0";
  } else {
    registerBtn.style.opacity = "0";
    registerBtn.style.zIndex = "0";
    loginBtn.style.opacity = "1";
    loginBtn.style.zIndex = "999";
  }

  // Toggle headings
  if (leftHeading.style.opacity === "0") {
    leftHeading.style.opacity = "1";
    leftHeading.style.zIndex = "999";
    rightHeading.style.opacity = "0";
    rightHeading.style.zIndex = "0";
  } else {
    leftHeading.style.opacity = "0";
    leftHeading.style.zIndex = "0";
    rightHeading.style.opacity = "1";
    rightHeading.style.zIndex = "999";
  }
...
registerBtn.addEventListener("click", toggleElements);
loginBtn.addEventListener("click", toggleElements);

// Set initial CSS properties for buttons (show register button by default)
registerBtn.style.opacity = "1";
registerBtn.style.zIndex = "999";
loginBtn.style.opacity = "0";
loginBtn.style.zIndex = "0";

// Set initial CSS properties for headings
leftHeading.style.opacity = "0";
leftHeading.style.zIndex = "0";
rightHeading.style.opacity = "1";
rightHeading.style.zIndex = "999";
